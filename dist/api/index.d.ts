...
export { type Coordinates, type GeoJSONFeatureCollection, type JsonError, type ParcelTree, type PoiDetail, RES_API_BASE_URL, type ResApiClient, type ResApiClientOptions, type SignalRecord, type SwissnovoImage, type components, createResApiClient, type operations, type paths };
